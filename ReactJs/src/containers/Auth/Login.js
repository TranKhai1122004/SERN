...
class Login extends Component {
    ...
    handleLogin = async () => {
        ...
        try {
            ...
            console.log("Tran Khai", error.response);
    ...
    handleShowHidePassword = () => {
        this.setState({
            isShowPassword: !this.state.isShowPassword //set nó mặc định là false
        })
    }
