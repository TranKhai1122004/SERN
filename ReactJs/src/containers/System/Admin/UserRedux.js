...
class UserRedux extends Component {
    ...
    checkValidateInput = () => {  // hàm này check nếu chưa nhập dữ liệu vào input nó sẽ trả về false và alert
        let isValid = true;
                    ...
                    <div className="user-redux-body" >
                        <div className='container'>
                            <div className='row'>
                                ...
                                <div className='col-3'>
                                    <label className='avatar'><FormattedMessage id='manage-user.image' /></label>
