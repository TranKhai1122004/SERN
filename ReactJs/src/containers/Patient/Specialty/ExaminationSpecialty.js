...
import './ExaminationSpecialty.scss';
import { withRouter } from 'react-router-dom';
import { LANGUAGES } from '../../../utils';
import { FormattedMessage } from 'react-intl';

class ExaminationSpecialty extends Component {
        ...
        return (
            <div className="examination-container">
                ...
                <div className='content-up'>
                    <div className='text'>
                        <div><FormattedMessage id = 'specialty.common'/></div>
                    </div>
                </div>
...
export default withRouter(connect(mapStateToProps)(ExaminationSpecialty));
