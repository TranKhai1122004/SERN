...
let getDetailDotorById = (inputId) => {
    return new Promise(async (resolve, reject) => {
        try {
            if (!inputId) {
                resolve({
                ...
                let data = await db.User.findOne({
                    ...
                    include: [
                        {
                            model: db.Markdown,
                            attributes: ['description', 'contentHTML', 'contentMarkdown', 'contentHTMLEn', 'descriptionEn']
                        },
                        {
                            model: db.ALLcode, as: 'positionData', attributes: ['valueEn', 'valueVi']
                        },
            ...
            if (!doctorId) {
                ...
                let data = await db.User.findOne({
                    ...
                    include: [
                        {
                            model: db.Markdown,
                            attributes: ['description', 'descriptionEn', 'contentHTML', 'contentMarkdown']
                        },
                        { model: db.ALLcode, as: 'positionData', attributes: ['valueEn', 'valueVi'] },
                        {
...
module.exports = {
    ...
    getDetailDotorById: getDetailDotorById,
