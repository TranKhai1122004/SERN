...
let initWebRoutes = (app) => {
    ...
    router.get('/delete-crud', homeController.deleteCRUD); // method get là lấy còn post là chuyển hướng trang
    //userController
    ...
    //clinicController
    router.post('/api/create-new-clinc', clinicController.createClinic);
